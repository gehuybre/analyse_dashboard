      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-6">
          <p className="text-muted-foreground">
            ...
            Get started by exploring our sample reports or creating your own.
          </p>
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Browse public reports with real data examples
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
              ...
              <div>
                <h4 className="font-medium">Private Access</h4>
                <p className="text-sm text-muted-foreground">
                  Try the admin login with password: <Badge variant="outline" className="ml-1">admin123</Badge>
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Share charts and tables via iframe codes
                </p>
              </div>
            </div>
          </div>
